...
public class FileServiceImpl implements FileService {
    ...
    private String filePath = "D:\\file_upload";
    ...
    @Override
    public List<Fileses> getFilesByCategory(String category) {
        // 通过MyBatis传参实现筛选
        return fileDao.getFilesByCategory(category);
    }

    @Override
    public List<Fileses> getAllFiles() {
        // 获取所有文件列表
